...
$sql1 = "delete from  acct_info_less60;";
        //echo '<br />';
$db->exec($sql1);
...
foreach($loadedSheetNames as $sheetIndex => $loadedSheetName) {
	...
	for($i=1;$i<=count($sheetData);$i++){
		...
		$sql1 = "insert into acct_info_less60(acct_name,log_time) 
		select '{$sheetData[$i]['A']}',DATETIME ('now', 'localtime')  ";
        //echo '<br />';
		//echo $sql1;
...
$result = $db->query("select a.acct_name,a.log_time, b.user_pwd,b.game_server from acct_info_less60 a inner join excel_acct_info b on a.acct_name = b.acct_user order by a.log_time desc ; ");
/**
var_dump();
*/
$xuhao =1;
